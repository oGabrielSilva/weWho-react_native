      ...
      <View>
        ...
        <TouchableOpacity
          ...
          <Icon
            ...
            size={Fonts.SIZES.regular}
            color={Colors.TEXT}
            style={{ marginRight: Margins.MARGINS.small }}
          />
          <Font type="text" size={Fonts.SIZES.regular}>
            {strings.buttons.remember}
          </Font>
        </TouchableOpacity>
        <TouchableOpacity
          onPress={() => {}}
          style={[styles.viewShowPassword, styles.flexCenter]}>
          <Font type="text" center>
...
const styles = StyleSheet.create({
  ...
  flexCenter: {
    ...
    marginTop: Margins.MARGINS.medium,
    marginBottom: Margins.MARGINS.large * 1.5,
  },
});
